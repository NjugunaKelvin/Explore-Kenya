      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <section className="mb-20 relative h-screen min-h-[600px] flex items-center justify-center">
          ...
          <div className="absolute bottom-10 left-0 right-0 flex justify-center">
            <svg className="animate-bounce w-8 h-8 text-[#F5C518]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <footer className="bg-[#1A1A1A] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-bold mb-4 uppercase tracking-wider border-b border-[#F5C518] pb-2 subtitle">Invest Kenya</h3>
              <p className="text-[#CCCCCC] body-text">
                Your gateway to investment opportunities in East Africa's most dynamic economy.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-[#CCCCCC] body-text">
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Kenya Investment Authority</a></li>
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Sector Profiles</a></li>
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Investment Process</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-bold mb-4 uppercase tracking-wider border-b border-[#F5C518] pb-2 subtitle">Resources</h3>
              <ul className="space-y-2 text-[#CCCCCC] body-text">
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Tax Handbook</a></li>
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Labor Laws</a></li>
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Economic Data</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-[#CCCCCC] body-text">
                ...
                <li className="flex items-start">
                  ...
                  <span>invest@kenya.go.ke</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-[#F5C518] pt-8 text-center text-[#CCCCCC] body-text">
            <p>© {new Date().getFullYear()} Invest Kenya. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
