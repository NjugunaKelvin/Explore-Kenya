      ...
      <footer className="bg-[#1A1A1A] text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <h3 className="text-lg font-bold mb-4 uppercase tracking-wider border-b border-[#F5C518] pb-2 subtitle">Kenya Manufacturing</h3>
              <p className="text-[#CCCCCC] body-text">
                Comprehensive resource on Kenya's industrial sector and investment opportunities.
              </p>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-[#CCCCCC] body-text">
                ...
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Manufacturers Directory</a></li>
                <li><a href="#" className="hover:text-[#F5C518] transition-colors">Export Processing Zones</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-[#CCCCCC] body-text">
                <li className="flex items-start">
                  ...
                  <span>info@kenyamanufacturing.co.ke</span>
                </li>
              </ul>
            </div>
          </div>
          <div className="border-t border-[#F5C518] pt-8 text-center text-[#CCCCCC] body-text">
            <p>© {new Date().getFullYear()} Kenya Manufacturing Portal. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
