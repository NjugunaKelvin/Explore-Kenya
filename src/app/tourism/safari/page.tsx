...
const SafariWildlife = () => {
  ...
  return (
    <>
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div 
                ...
                data-aos-delay="300"
              >
                <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white drop-shadow-lg">{slide.title}</h1>
                <p className="text-2xl md:text-3xl mb-4 text-green-300 font-medium drop-shadow-md">{slide.subtitle}</p>
                <p className="text-lg md:text-xl mb-8 text-gray-100 max-w-2xl mx-auto drop-shadow-sm">{slide.description}</p>
                <Link 
                  href={slide.link}
                  className="inline-block bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
                  data-aos="fade-up"
                  data-aos-delay="600"
                >
                  {slide.cta}
        ...
        <div className="absolute bottom-12 left-0 right-0 flex justify-center gap-3">
          {heroSlides.map((_, index) => (
            <button
              ...
              className={`w-4 h-4 rounded-full transition-all ${index === currentSlide ? 'bg-green-500 w-6' : 'bg-white bg-opacity-50 hover:bg-opacity-100'}`}
      ...
      <section id="introduction" className="py-20 px-4 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              <span className="text-green-400">Kenya's</span> Wildlife Kingdom
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-green-500 to-red-600 mx-auto mb-8"></div>
          ...
          <div 
            ...
            data-aos-delay="200"
          >
            <div className="bg-gray-800 p-8 rounded-xl border-l-4 border-green-500 hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
            ...
            <div className="bg-gray-800 p-8 rounded-xl border-l-4 border-red-500 hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
            ...
            <div className="bg-gray-800 p-8 rounded-xl border-l-4 border-black hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
      ...
      <section id="parks" className="py-20 px-4 bg-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              Kenya's <span className="text-green-400">Premier Wildlife</span> Sanctuaries
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-red-600 to-green-500 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            ...
            {nationalParks.map((park, index) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                  ...
                  <p className="text-gray-200 mb-4 line-clamp-2">{park.description}</p>
          ...
          >
            <Link 
              ...
              className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
      ...
      {/* Wildlife Section */}
      <section id="wildlife" className="py-20 px-4 bg-gray-900">
        <div className="max-w-7xl mx-auto">
          <div 
            className="text-center mb-16"
            data-aos="fade-up"
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              Meet Kenya's <span className="text-green-400">Wildlife Stars</span>
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-green-500 to-red-600 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                  ...
                  >
                    <div className="relative h-64">
                      ...
                      <div className="absolute bottom-4 left-4">
                        ...
                        <p className="text-sm text-gray-300">{animal.scientific}</p>
                      </div>
                      <span className={`absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-bold ${
                        ...
                        animal.status === 'Vulnerable' ? 'bg-yellow-500 text-gray-900' : 'bg-green-500 text-white'
                      }`}>
                        {animal.status}
                      </span>
                    </div>
                    <div className="p-6">
                      <div className="mb-4">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm text-gray-400">Population in Kenya:</span>
                          <span className="text-sm font-medium text-white">{animal.population}</span>
                        </div>
                        <div className="h-1 bg-gray-700 rounded-full">
                          <div 
                            className={`h-1 rounded-full ${
                              ...
                              animal.status === 'Vulnerable' ? 'bg-yellow-500' : 'bg-green-500'
                            }`}
                      ...
                      <h5 className="font-bold text-white mb-2">Interesting Facts:</h5>
                      <ul className="space-y-2 mb-4">
                        {animal.facts.map((fact, index) => (
                          <li key={index} className="flex items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-400 mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
      ...
      <section id="packages" className="py-20 px-4 bg-gray-950">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              <span className="text-green-400">Tailored</span> Safari Experiences
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-red-600 to-green-500 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              >
                <div className="relative h-64">
                  ...
                  <div className="absolute bottom-4 left-4">
                    ...
                    <p className="text-green-300 font-medium">{pkg.price}</p>
                  </div>
                </div>
                <div className="bg-gray-900 p-6">
                  ...
                  <div className="mb-4">
                    <h4 className="font-bold text-white mb-2">Destinations:</h4>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button className="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-6 rounded-lg transition-colors duration-300">
                      Enquire
                    </button>
                  </div>
                </div>
      ...
      <section id="migration" className="py-20 px-4 bg-gradient-to-b from-gray-900 to-gray-800">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="absolute bottom-6 left-6 right-6">
                <div className="bg-black bg-opacity-60 p-4 rounded-lg">
                  <p className="text-white italic">"The greatest wildlife spectacle on Earth" - National Geographic</p>
                </div>
              </div>
            </div>
            ...
            >
              <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
                The <span className="text-green-400">Great Migration</span>
              </h2>
              <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-red-600 mb-8"></div>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">River Crossings</h4>
                    <p className="text-gray-300">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">Predator Action</h4>
                    <p className="text-gray-300">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-1">Best Viewing Times</h4>
                    <p className="text-gray-300">
              ...
              <Link 
                ...
                className="inline-flex items-center bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-lg transition-colors duration-300"
              >
      ...
      <section id="conservation" className="py-20 px-4 bg-gray-800">
        <div className="max-w-7xl mx-auto">
          <div 
            className="text-center mb-16"
            data-aos="fade-up"
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              <span className="text-green-400">Conservation</span> Leadership
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-green-500 to-red-600 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          ...
          >
            <div>
              <h3 className="text-2xl font-bold mb-6 text-white">Kenya's Conservation Milestones</h3>
              
              <div className="space-y-6">
                <div className="flex">
                  <div className="bg-green-500 text-white font-bold rounded-full h-10 w-10 flex items-center justify-center mr-4 flex-shrink-0">1</div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">1977 Hunting Ban</h4>
                    <p className="text-gray-300">
                ...
                <div className="flex">
                  <div className="bg-green-500 text-white font-bold rounded-full h-10 w-10 flex items-center justify-center mr-4 flex-shrink-0">2</div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">1989 Ivory Burn</h4>
                    <p className="text-gray-300">
                ...
                <div className="flex">
                  <div className="bg-green-500 text-white font-bold rounded-full h-10 w-10 flex items-center justify-center mr-4 flex-shrink-0">3</div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">Community Conservancies</h4>
                    <p className="text-gray-300">
                ...
                <div className="flex">
                  <div className="bg-green-500 text-white font-bold rounded-full h-10 w-10 flex items-center justify-center mr-4 flex-shrink-0">4</div>
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">2016 Ivory Ban</h4>
                    <p className="text-gray-300">
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="bg-gray-800 p-6 rounded-lg">
                  <div className="text-green-400 text-4xl font-bold mb-2">80%</div>
                  <p className="text-gray-300">Reduction in elephant poaching since 2013</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-lg">
                  <div className="text-green-400 text-4xl font-bold mb-2">160+</div>
                  <p className="text-gray-300">Community conservancies protecting wildlife</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-lg">
                  <div className="text-green-400 text-4xl font-bold mb-2">35,000</div>
                  <p className="text-gray-300">Elephants currently in Kenya (up from 16,000 in 1989)</p>
                </div>
                <div className="bg-gray-800 p-6 rounded-lg">
                  <div className="text-green-400 text-4xl font-bold mb-2">800+</div>
                  <p className="text-gray-300">Black rhinos (2nd largest population after Namibia)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div 
            ...
            data-aos="fade-up"
          >
            <h3 className="text-2xl font-bold mb-8 text-white text-center">Key Conservation Organizations</h3>
            
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {conservationOrgs.map((org, index) => (
                <div 
                  key={org.id}
                  className="bg-gray-900 rounded-lg p-6 hover:transform hover:scale-105 transition-transform duration-300 shadow-lg"
                  data-aos="fade-up"
                  data-aos-delay={index * 100}
                >
                  ...
                  <p className="text-gray-400 text-sm text-center mb-3">{org.focus}</p>
                  <p className="text-green-400 text-sm text-center font-medium mb-4">{org.achievements}</p>
                  <Link 
                    href={org.link}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="block text-center text-sm text-white bg-green-600 hover:bg-green-700 py-2 px-4 rounded transition-colors"
                  >
                    Visit Website
                  </Link>
                </div>
          ...
          <div 
            className="bg-gradient-to-r from-green-900 to-black rounded-xl p-8 md:p-12 shadow-2xl overflow-hidden relative"
            data-aos="fade-up"
          >
            <div className="absolute -right-20 -top-20 w-64 h-64 bg-green-400 rounded-full opacity-10"></div>
            <div className="absolute -left-20 -bottom-20 w-64 h-64 bg-red-600 rounded-full opacity-10"></div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-black bg-opacity-30 p-6 rounded-lg">
                  ...
                  <h4 className="text-xl font-bold text-white mb-2">Travel Responsibly</h4>
                ...
                <div className="bg-black bg-opacity-30 p-6 rounded-lg">
                  <div className="text-green-400 text-3xl mb-3">💚</div>
                  <h4 className="text-xl font-bold text-white mb-2">Support Conservation</h4>
                  <ul className="text-gray-300 space-y-2 text-sm">
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-400 mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <div className="bg-black bg-opacity-30 p-6 rounded-lg">
                  <div className="text-green-400 text-3xl mb-3">📢</div>
                  <h4 className="text-xl font-bold text-white mb-2">Spread Awareness</h4>
                  <ul className="text-gray-300 space-y-2 text-sm">
                    <li className="flex items-start">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-green-400 mr-2 mt-1 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      {/* Planning Section */}
      <section id="planning" className="py-20 px-4 bg-gray-950">
        <div className="max-w-7xl mx-auto">
          <div 
            className="text-center mb-16"
            data-aos="fade-up"
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              Planning Your <span className="text-green-400">Kenyan Safari</span>
            </h2>
            <div className="w-32 h-1 bg-gradient-to-r from-red-600 to-green-500 mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
          ...
          <div 
            ...
            data-aos="fade-up"
          >
            <div className="bg-gray-900 p-8 rounded-xl border-t-4 border-green-500 hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
              <div className="text-green-400 text-4xl mb-4">📅</div>
            ...
            <div className="bg-gray-900 p-8 rounded-xl border-t-4 border-red-500 hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
              <div className="text-red-400 text-4xl mb-4">🧳</div>
            ...
            <div className="bg-gray-900 p-8 rounded-xl border-t-4 border-black hover:transform hover:scale-105 transition-all duration-300 shadow-lg">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <Link 
                  href="/contact" 
                  className="bg-green-600 hover:bg-green-700 text-white font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg"
                >
                  Contact Our Safari Experts
                </Link>
                <Link 
                  href="/safari-faq" 
                  className="bg-gray-800 hover:bg-gray-700 text-white font-bold py-4 px-10 rounded-lg transition-all duration-300 transform hover:scale-105"
                >
                  Safari FAQs
                </Link>
              </div>
